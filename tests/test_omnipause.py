...
def test_toggle_enters_omnipause_when_not_already_paused():
    plan = build_omnipause_plan("toggle", omni_paused=False, main_mode="nau")
...
def test_leave_nau_mode_resumes_nau():
    plan = build_omnipause_plan("leave", omni_paused=True, main_mode="nau")
...
def test_relief_enters_omnipause_but_retracts_the_osr2():
    ...
    plan = build_omnipause_plan("relief", omni_paused=False, main_mode="nau")
...
def test_leave_hybrid_mode_resumes_nau():
    ...
    # resumes Nau, not any separate main player.
    plan = build_omnipause_plan("leave", omni_paused=True, main_mode="hybrid")
