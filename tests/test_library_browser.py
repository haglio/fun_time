...
def test_the_sidebar_lists_the_folders_videos_under_a_heading_per_letter(tmp_path: Path):
    window = LibraryBrowserWindow(
        [
...
def test_the_sidebar_is_alphabetical_where_the_grid_is_ranked(tmp_path: Path):
...
def test_a_heading_is_not_something_the_arrows_can_land_on(tmp_path: Path):
...
def test_a_name_with_no_letter_to_file_under_goes_to_the_hash_heading(tmp_path: Path):
...
def test_the_way_back_is_not_in_the_sidebar(tmp_path: Path):
...
def test_the_sidebar_follows_the_folder_that_is_open(tmp_path: Path):
    window = LibraryBrowserWindow(
        [
            _handle("Alpha Scene", section="big_batch"),
            _handle("Mike Scene", section="small_batch"),
...
def test_choosing_a_name_moves_the_grid_to_it(tmp_path: Path):
...
def test_activating_a_name_in_the_sidebar_plays_that_video(tmp_path: Path):
    picked: list[str] = []
    window = LibraryBrowserWindow(
...
def test_activating_a_folder_in_the_sidebar_walks_into_it(tmp_path: Path):
    window = LibraryBrowserWindow(
        [_handle("Alpha Scene", section="big_batch")],
        thumbnail_cache=tmp_path,
        on_pick=lambda _v: None,
...
def test_backspace_from_the_sidebar_goes_back_up_too(tmp_path: Path):
...
def test_a_letter_group_holds_every_name_that_starts_with_it(tmp_path: Path):
...
def test_a_long_title_stays_inside_the_sidebar(tmp_path: Path):
...
def test_the_grid_takes_the_focus_though_the_sidebar_stands_first(tmp_path: Path):
