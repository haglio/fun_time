...
from fun_time.windows_bridge_robot_hand_app import build_parser, main
...
def test_main_apply_toggle_enabled_writes_state_files_and_primary_playback(tmp_path: Path):
    ...
    with patch("fun_time.windows_bridge_robot_hand_app.ensure_playback_state", return_value=True) as ensure_playback:
        code = main([
