...
from fun_time.windows_bridge_vlc_actions_app import build_parser, main
...
def test_main_returns_zero_when_replace_playlist_succeeds(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "fun_time.windows_bridge_vlc_actions_app.replace_playlist_from_file",
...
def test_main_writes_current_file_path_output(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "fun_time.windows_bridge_vlc_actions_app.get_current_file_path",
...
def test_main_returns_zero_when_send_command_succeeds(monkeypatch):
    monkeypatch.setattr(
        "fun_time.windows_bridge_vlc_actions_app.vlc_http_cmd",
