...
from fun_time.controller_runtime_flow import (
...
def test_sync_robot_hand_reads_state_files_and_applies_playback(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "fun_time.controller_runtime_flow.ensure_playback_state",
...
def test_toggle_fmode_replaces_playlists_and_returns_new_state(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr("fun_time.controller_runtime_flow.replace_playlist_from_file", fake_replace)
