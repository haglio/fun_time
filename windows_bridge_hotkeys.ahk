...
; recenter.  Squeezing a controller's trigger and moving it turns and tilts the
; whole arrangement — these are for the desk.  Desktop main player ignores all three.
