...
def _cell(path: str, thumb: object, label: str = "") -> HudCell:
    """One map cell as the player draws it; an absent thumbnail draws a placeholder."""
...
def hud_model(panel: HudPanel, cache_dir: Path,
    ...
    return HudModel(
        ...
        rows=player_rows(panel.player, locked=panel.locked,
                         ...
                         in_vr=panel.in_vr, crowned=panel.crowned),
...
def hosted_model(player: str, hosted: HudModel | None, *, active: bool,
                 origenerator_ready: bool, in_vr: bool, crowned: bool = False) -> HudModel:
