...
def write_shared_state(state_file: Path, state: BridgeState) -> None:
    ...
    parser["state"] = {
        ...
        "portrait_loop_anchor": state.portrait_loop_anchor,
        "landscape_loop_anchor": state.landscape_loop_anchor,
...
def read_shared_state(state_file: Path) -> BridgeState | None:
    ...
    return BridgeState(
        ...
        portrait_loop_anchor=s.get("portrait_loop_anchor", ""),
        landscape_loop_anchor=s.get("landscape_loop_anchor", ""),
