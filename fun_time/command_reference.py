...
_SECTIONS: tuple[tuple[str, tuple[_Row, ...]], ...] = (
    (
        ...
        (
            ...
            _Row("Recents — (re)load Portrait/Landscape newest-first", ("P",), ("both_recents",)),
            _Row("Shuffle — reshuffle Portrait/Landscape (cancels Recents; keeps filters)", (), ("both_shuffle",)),
    ...
    (
        ...
        (
            ...
            _Row(
                ...
                "in order; \"full video\" jumps to its source scene; \"money "
    ...
    (
        ...
        (
            ...
            _Row("Recents portrait — reload it newest-first", (), ("portrait_recents",)),
            _Row("Shuffle portrait — reshuffle it (cancels Recents; keeps the filter)", (), ("portrait_shuffle",)),
    ...
    (
        ...
        (
            ...
            _Row("Recents landscape — reload it newest-first", (), ("landscape_recents",)),
            _Row("Shuffle landscape — reshuffle it (cancels Recents; keeps the filter)", (), ("landscape_shuffle",)),
    ...
    (
        ...
        (
            ...
            _Row("Shuffle both — reshuffle each (cancels Recents; keeps filters)", (), ("both_shuffle",)),
    ...
    (
        ...
        (
            ...
            _Row("Recents on the active side — reload it newest-first", (), ("active_recents",)),
            _Row("Shuffle the active side (cancels Recents; keeps the filter)", (), ("active_shuffle",)),
