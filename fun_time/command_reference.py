...
_SECTIONS: tuple[tuple[str, tuple[_Row, ...]], ...] = (
    ...
    (
        ...
        (
            ...
            _Row("Stop looping portrait — back to browse, keep the filter", ("Home",), ("portrait_no_loop",)),
    ...
    (
        ...
        (
            ...
            _Row("Stop looping landscape — back to browse, keep the filter", ("E",), ("landscape_no_loop",)),
