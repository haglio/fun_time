...
_SECTIONS: tuple[tuple[str, tuple[_Row, ...]], ...] = (
    (
        ...
        (
            ...
            _Row("Mute voice control", ("Backspace",), ("voice_toggle", "voice_off")),
            _Row("Broker start / stop", ("B",), ("broker_panel", "broker_start", "broker_stop")),
        ),
    ),
    (
        "Primary VLC",
    ...
    (
        ...
        (
            _Row("Amplitude up / down", ("I", "K"), ("genau_amplitude_up", "genau_amplitude_down"),
                 ("min amp", "max amp", "amp 0–100")),
            _Row("Center up / down", ("O", "U"), ("genau_center_up", "genau_center_down"),
                 ("min center", "max center", "center 0–100")),
            _Row("Speed up / down", ("L", "J"), ("genau_speed_up", "genau_speed_down"),
                 ("min speed", "max speed", "speed 0–100")),
            _Row("Next / previous waveform shape", (",",), ("genau_cycle_shape", "genau_cycle_shape_prev")),
            ...
            _Row("Cruise control", ("C",), ("genau_toggle_cruise", "genau_cruise_on", "genau_cruise_off")),
            _Row("Offset ¼ cycle", ("\\",), ("backslash_key",)),
        ),
    ),
)
