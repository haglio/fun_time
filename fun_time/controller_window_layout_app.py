...
from .controller_window_layout import (
    MonitorRect,
    Size,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--primary-top-ratio", required=True, type=float)
    parser.add_argument("--landscape-width-ratio", required=True, type=float)
    parser.add_argument("--mfp-width-ratio", required=True, type=float)
    parser.add_argument("--mfp-height-ratio", required=True, type=float)
