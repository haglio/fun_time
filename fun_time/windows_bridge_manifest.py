...
def build_windows_bridge_manifest(config, vlc_http_pass: str) -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        "modules": {
            ...
            "windows_bridge_lock_module": "fun_time.windows_bridge_lock_app",
            "windows_bridge_window_layout_module": "fun_time.windows_bridge_window_layout_app",
            "windows_bridge_vlc_actions_module": "fun_time.windows_bridge_vlc_actions_app",
            ...
            "windows_bridge_dashboard_bridge_module": "fun_time.windows_bridge_dashboard_bridge_app",
            "windows_bridge_runtime_flow_module": "fun_time.windows_bridge_runtime_flow_app",
        },
        "commands": {
