...
- `0` = the broker holds the OSR2 under Fun Time's control (the main player owns playback)
- `1` = the broker is running the OSR2 itself, in its auto mode

The audio companion and the Python dispatch loop both read this file as the authoritative source of whether the broker's auto mode is actually active.
