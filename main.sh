...
ROBOT_MODE_HAND_FILE="/c/path/to/suite-root/projects/fun_time/robot_hand_mode.txt"
ROBOT_HAND_CMD_FILE="/c/path/to/suite-root/projects/fun_time/robot_hand_cmd.txt"
...
ROBOT_MODE_HAND_FILE_WIN="$(to_win_path "$ROBOT_MODE_HAND_FILE")"
...
MSYS2_ARG_CONV_EXCL='*' MSYS_NO_PATHCONV=1 "$AHK_WIN" "$AHK_SCRIPT_WIN" \
  ...
  "$ROBOT_MODE_HAND_FILE_WIN" "$ROBOT_HAND_CMD_FILE_WIN"